    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="{{URL::to('/register-customer')}}" method="POST">
                ...
                <input type="email" name="userSignUp" placeholder="Email" />
                <input type="password" name="passSignUp" placeholder="Mật khẩu" />
        ...
        <div class="form-container sign-in-container">
            <form action="{{'/login-customer'}}" method="POST">
                {{ csrf_field() }}
                <h1> Đăng nhập </h1>
                <input type="email" name='userSignIn' placeholder="Email" />
                <input type="password" name='passSignIn' placeholder="Mật khẩu" />
