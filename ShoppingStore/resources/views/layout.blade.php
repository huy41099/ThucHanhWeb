				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{URL::to('/home-page')}}"><img src="{{('public/frontend/images/home/logo.png')}}" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="{{URL::to('admin-login')}}"><i class="fa fa-user"></i> Quản trị viên</a></li>
								...
								?>
									<li><a href="{{URL::to('login-page')}}"><i class="fa fa-lock"></i>Đăng nhập</a></li>
								<?php	
									}
								?>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{URL::to('/home-page')}}" class="active">Trang chủ</a></li>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a href="{{URL::to('category-product/'.$valueCate->category_id)}}">
										{{$valueCate->category_name}}</a></h4>
								</div>
							</div>
							@endforeach
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="{{URL::to('brand_product/'.$valueBrand->brand_id)}}">
										{{$valueBrand->brand_name}}</a></li>
								</ul>
							</div>
							@endforeach
						</div><!--/brands_products-->
